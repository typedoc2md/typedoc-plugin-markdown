...
| :------------------------------------------------------------------------- | :------------------------------------------------------------------------ | :------------------------------------------------------------------------------- | :-------------------------------------------------------------- |
| [typedoc-plugin-markdown](./packages/typedoc-plugin-markdown#readme)       | A TypeDoc plugin that generates TypeScript API documentation as Markdown. | ![Downloads](https://img.shields.io/npm/dw/typedoc-plugin-markdown?label=npm)    | [Changelog](./packages/typedoc-plugin-markdown/CHANGELOG.md)    |
