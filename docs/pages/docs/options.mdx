...
<Callout emoji="📁">Determines which members are exported to their own file when `outputFileStrategy` equals `members`.</Callout>
...
<Callout emoji="📁">Specify the file extension for generated output files.</Callout>
...
<Callout emoji="📁">The name of a module that should act as the root page for the documentation.</Callout>
...
<Callout emoji="📁">Merges the resolved readme into the project index page.</Callout>
...
<Callout emoji="💡">Excludes grouping by kind so all members are rendered and sorted at the same level.</Callout>
...
<Callout emoji="💡">Expand parameters in signature parentheses to display type information.</Callout>
...
<Callout emoji="💡">Specify the render style of parameter and type parameter groups.</Callout>
...
<Callout emoji="💡">Specify the render style of property groups for interfaces and classes.</Callout>
...
<Callout emoji="💡">Specify the render style for type declaration members.</Callout>
...
<Callout emoji="💡">Provides a mechanism to change the content of text used in documentation.</Callout>
