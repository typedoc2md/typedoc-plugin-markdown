...
The following example shows a very basic plugin skeleton:
...
See [TypeDoc plugin documentation](https://typedoc.org/documents/Development.Plugins.html) for more information.
