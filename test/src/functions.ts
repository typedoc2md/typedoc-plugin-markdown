...
import { INameInterface } from './classes';
 ...
 *
 */
var variableFunction = function (paramZ: string, paramG: any, paramA: INameInterface): number {
  return 0;
};
 ...
 *
 */
export function functionWithArguments(paramZ: string, paramG: any, paramA: INameInterface): number {
  return 0;
}
