...
If something does not make sense please do not hesitate to ask for help in
[GitHub Discussions](https://github.com/typedoc2md/typedoc-plugin-markdown/discussions/categories/help).
...
The site is built on [Nextra](https://nextra.site/docs) and you can edit the MDX
files located in the [docs folder](https://github.com/typedoc2md/typedoc-plugin-markdown/tree/main/docs)
of the repo.
...
Please have a look at the codebase and follow documentation comments and
provided internal docs.
