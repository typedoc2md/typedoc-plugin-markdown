  ...
  plugins: [
    ...
    [
      docusaurusPlugin,
      {
        ...
        entryPoints: [
          '../../../packages/typedoc-plugin-markdown/test/fixtures/src/categories/module-1.ts',
          '../../../packages/typedoc-plugin-markdown/test/fixtures/src/categories/module-2.ts',
          '../../../packages/typedoc-plugin-markdown/test/fixtures/src/categories/module-3.ts',
        ],
        router: 'category',
        cleanOutputDir: true,
        navigation: {
