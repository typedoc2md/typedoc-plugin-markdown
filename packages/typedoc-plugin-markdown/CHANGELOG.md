...
- Improved rendering of union types when documented type details are present ([#857](https://github.com/typedoc2md/typedoc-plugin-markdown/issues/857)).
...
- Added locale translations for grouped `@example` headings ([#858](https://github.com/typedoc2md/typedoc-plugin-markdown/issues/858)).
