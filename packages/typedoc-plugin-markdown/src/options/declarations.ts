 ...
 * - `keyword`: The translated keyword for the symbol, if applicable (e.g., "Abstract", "Const").
 * - `codeKeyword`: The code keyword for the symbol, if applicable (e.g., `abstract`, `const`).
